 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Tool_Project_Context_Zf_H5bpApplicationConfigFile extends Zend_Tool_Project_Context_Filesystem_File
{
    ...
    {
        return 'H5bpApplicationConfigFile';
    }
...
; The baseUrl is normally auto detected. Uncomment to explicitly set it to a new value.
; If you uncomment the following line, you will also need to edit the Bootstrap.php file.
