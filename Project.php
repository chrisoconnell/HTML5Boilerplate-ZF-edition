    ...
    //implements Zend_Tool_Framework_Provider_DocblockManifestInterface
{
    ...
    public function create($path, $nameOfProfile = null, $fileOfProfile = null)
    {
        ...
        $response->appendContent(
            'This command created an HTML 5 Boilerplate ready web project, '
...
<projectProfile type="default" version="1.10">
    <projectDirectory>
        ...
        <applicationDirectory>
            ...
            <configsDirectory>
                <h5bpApplicationConfigFile type="ini" />
            </configsDirectory>
            ...
            <layoutsDirectory>
            	<layoutScriptsDirectory>
            		<h5bpLayoutScriptFile layoutName="layout" />
            	</layoutScriptsDirectory>
            </layoutsDirectory>
            <modelsDirectory />
            ...
            <viewsDirectory>
                <viewScriptsDirectory>
                    <viewControllerScriptsDirectory forControllerName="Index">
                        <h5bpViewScriptFile forActionName="index" />
                    </viewControllerScriptsDirectory>
                    <viewControllerScriptsDirectory forControllerName="Error">
                        <h5bpViewScriptFile forActionName="error" />
                    </viewControllerScriptsDirectory>
                </viewScriptsDirectory>
        ...
        <publicDirectory>
            <h5bpHtaccessFile />
            <h5bpPublicCrossdomainFile />
            <h5bpPublicStylesheetsDirectory>
	            <h5bpPublicStylesheetFile />
            </h5bpPublicStylesheetsDirectory>
            <h5bpPublicHumansFile />
            <h5bpPublicImagesDirectory />
            <publicIndexFile />
            <publicScriptsDirectory>
            	<h5bpJsLibsDirectory>
            		<H5bpJsLibsJqueryFile />
            		<h5bpJsLibsModernizrFile />
            	</h5bpJsLibsDirectory>
            	<h5bpJsMylibsDirectory />
            	<h5bpJsPluginsFile />
            	<h5bpJsSriptFile />
            </publicScriptsDirectory>
            <h5bpPublicRobotsFile />
        </publicDirectory>
...
CHANGE LOG
==========
Zend/Tool/Project/Provider/Project.php
	- File which sets the directory structure and files. 
